...
namespace ShootingEditor2D
{
    public class LevelEditor : MonoBehaviour
    {
        ...
        private void OnGUI()
        {
            ...
            {
                GUI.Label(modelLabelRect, mCurrentOperateMode+" : "+mCurrentBrusyType, mModeLableStyle.Value);
            }
            else
            {
                GUI.Label(modelLabelRect, mCurrentOperateMode.ToString(), mModeLableStyle.Value);
            }
            ...
            if (GUI.Button(saveButtonRect, "保存", mButtonStyle.Value))
            {
                ...
                var levelFilePath = levelFileFolder + "/" + System.DateTime.Now.ToString("yyyyMMddhhmmss") + ".xml";
